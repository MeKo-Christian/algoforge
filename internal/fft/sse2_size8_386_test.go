...
func TestSSE2Size8Radix2Complex64_386(t *testing.T) {
	...
	if !forwardSSE2Size8Radix2Complex64Asm(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("forwardSSE2Size8Radix2Complex64Asm failed")
	}

	if !inverseSSE2Size8Radix2Complex64Asm(dst, fwd, twiddle, scratch, bitrev) {
...
func TestSSE2Size8Radix2Complex128_386(t *testing.T) {
	t.Parallel()
	...
	if !forwardSSE2Size8Radix2Complex128Asm(fwd, src, twiddle, scratch, bitrev) {
		t.Fatal("forwardSSE2Size8Radix2Complex128Asm failed")
	}

	if !inverseSSE2Size8Radix2Complex128Asm(dst, fwd, twiddle, scratch, bitrev) {
